<script>
  import { Button, DarkMode, Navbar } from "flowbite-svelte"
  import "../app.postcss"
...
{#if $page.route.id != "/"}
  <header>
    <Navbar>
      <Button pill on:click={() => goBack()}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" class="mr-2 -ml-1 w-5 h-5">
          <g data-name="Layer 2">
